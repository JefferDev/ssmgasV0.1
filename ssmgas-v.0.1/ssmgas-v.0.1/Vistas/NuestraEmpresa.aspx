<%@ Page Title="" Language="C#" MasterPageFile="~/PaginaMaestra.Master" AutoEventWireup="true" CodeBehind="NuestraEmpresa.aspx.cs" Inherits="ssmgas_v._0._1.Vistas.NuestraEmpresa" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="contenedor cont-nuestraEmpresa">
        <div class="cont-perfil">
            ...
            <section>
                <article>
                    ...
                    <p>
                        La compañía está siempre en la búsqueda de nuevos procedimientos para mejorar su servicio y ofrecer un 
                        excelente acompañamiento en asesoría técnica. Esta es la razón por la que <strong>SSMGAS</strong> se lanza a un mercado 
                        donde la competitividad y el servicio hace la diferencia, pero nuestra compañía agrega una premisa, 
                        donde sus necesidades son nuestra prioridad con lo mas altos niveles de calidad en todos 
                        nuestros productos y servicios; sin olvidar nuestro talento humano que sin este sería imposible cumplir con nuestro objetivo.
                    </p>
                </article>
            </section>
        </div>
